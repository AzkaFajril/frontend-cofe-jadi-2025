      ...
      <div className="overflow-x-auto rounded-lg shadow-lg bg-white">
        <table className="min-w-full divide-y divide-gray-200">
          <thead className="bg-gradient-to-r from-blue-50 to-green-50">
            <tr>
              <th className="px-6 py-3 text-xs font-bold text-gray-600 uppercase tracking-wider whitespace-nowrap text-center">Order ID</th>
              <th className="px-6 py-3 text-xs font-bold text-gray-600 uppercase tracking-wider whitespace-nowrap text-center">Items</th>
              <th className="px-6 py-3 text-xs font-bold text-gray-600 uppercase tracking-wider whitespace-nowrap text-center">Total</th>
              <th className="px-6 py-3 text-xs font-bold text-gray-600 uppercase tracking-wider whitespace-nowrap text-center">Status</th>
              <th className="px-6 py-3 text-xs font-bold text-gray-600 uppercase tracking-wider whitespace-nowrap text-center">Payment</th>
              <th className="px-6 py-3 text-xs font-bold text-gray-600 uppercase tracking-wider whitespace-nowrap text-center">Update Status</th>
            </tr>
          </thead>
